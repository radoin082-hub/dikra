...
$student_id = mysqli_fetch_assoc($result_id)['id'];
$sql_assets = "SELECT assamentstudent.*, topic.* FROM assamentstudent INNER JOIN topic ON assamentstudent.title_id = topic.id WHERE assamentstudent.student_email = '$user_email'";
...
$asstes = mysqli_fetch_all($result_assts, MYSQLI_ASSOC);
/*
echo "<pre>";
print_r($asstes);
echo "</pre>";*/
...
<section class="home-section" id="assessment" style="display: none;">
    ...
    <table class="-table">
      ...
      <?php foreach ($asstes as $w): ?>
        <tr>
          <td><?php echo $w['title_id']; ?></td>
          <td><?php echo $w['title']; ?></td>
          <td><?php echo $w['speciality']; ?></td>
          <td><?php echo $w['professeur']; ?></td>
...
[0] => Array
(
[student_email] => amrisamer55@gmail.com
[title_id] => 16
[id] => 16
[title] => theme3
[resume] => dess
